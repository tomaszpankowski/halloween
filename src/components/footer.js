...
class Footer extends Component{
    render(){
        return(
            <footer>
                <Container fluid className="d-flex align-items-center bg-danger text-dark pt-3 opacity-9 border-top border-dark">
                    <Row className="mx-0 w-100 small opacity-9">
                        <Col xs={12} md={6} lg={5} className="text-center text-md-start">
                            ...
                            <p className="initialism fw-normal text-dark">
